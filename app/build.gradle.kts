...
android {
    namespace = "com.fan.me"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.fan.me"
        minSdk = 34
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation(libs.androidx.compose.ui.ui.tooling2)
    ...
    implementation(libs.androidx.constraintlayout.constraintlayout.compose2)
